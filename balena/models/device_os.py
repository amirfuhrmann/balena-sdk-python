...
class DeviceOs(object):
    ...
    def __parse_balena_semver(self, os_version):
        """
        ...
        version = re.sub(r'\.rev', '+rev', os_version)
        # fix major.minor.patch.prod to be treat .dev & .prod as build metadata
        version = re.sub(r'\.(dev|prod)', r'+\1', version)
    ...
    def get_device_os_semver_with_variant(self, os_version, os_variant):
        ...
        version_info = semver.VersionInfo.parse(self.__parse_balena_semver(os_version))
